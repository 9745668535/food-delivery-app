              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Row(
                      children: [
                        Icon(Icons.location_on,color: ColorResource.orangeButtton,),
                        SizedBox(width: 10,),
                        Column(crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            InkWell(
                              ...
                              child: Row(
                                children: [
                                  Text("Delivery Point",style: StyleResource.headBold(context, 14).copyWith(fontWeight: FontWeight.w400),),
                                  Icon(Icons.keyboard_arrow_down_outlined,color: Colors.black,)
                                ],
                              ),
                            ),
                            Text("Transaco hotel,behind navrongo campus",style: StyleResource.greyHead(context, 12).copyWith(fontWeight: FontWeight.w400),)
                          ],
                        )
                      ],
                    ),
                    Icon(Icons.account_circle,color: ColorResource.orangeButtton,size: 40,)
                  ],
                ),
              ),
          Padding(
            ...
            child: Container(
              ...
              child: TextFormField(
                decoration: InputDecoration(contentPadding: EdgeInsets.symmetric(horizontal: 20,vertical: 15),
                  ...
                  prefixIcon:Icon(Icons.search,color: ColorResource.orangeButtton,),
                  suffixIcon:Icon(Icons.mic,color: ColorResource.orangeButtton,),
                      ...
                      child: Padding(
                        ...
                        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Carters of Moseley",style: StyleResource.headBold(context, 12).copyWith(color: Colors.black,),),
                                Text("British cooking",style: StyleResource.greyHead(context, 10).copyWith(color: ColorResource.greyLight),)
                              ],
                            ),
                            Container(
                              decoration: BoxDecoration(color: ColorResource.greenDark,
                                  borderRadius: BorderRadius.circular(3)),
                              child: Padding(
                                padding: const EdgeInsets.only(left: 8.0,right: 8),
                                child: Row(
                                  children: [
                                    Text("4.3",style: StyleResource.loginHead(context, 10).copyWith(color: Colors.white,
              ...
              Padding(
                padding: const EdgeInsets.all(8.0),
                child: Text("Great Deals",style: StyleResource.headBold(context, 18),),
              ),
              SizedBox(height: 10,),
              _renderSlider(),
              SizedBox(height: 10,),
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.radio_button_on_sharp,color: Colors.red,size: 20,),
                        SizedBox(width: 5,),
                        Text("Non veg",style: StyleResource.greyHead(context, 10),)
                      ],
                    ),
